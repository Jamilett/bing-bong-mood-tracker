...
const mockData = [
  {
    ...
    image: Happy,
    journal:
      "Today was a good day, I walked my dog in the park and play with him with the ball. My sleep was great, I felt like new when I stood up.",
  },
  {
    date: "10/03/2025",
    mood: "Sad",
    image: Sad,
    journal:
      "Felt really down today. Didn't feel like getting out of bed and skipped breakfast.",
  },
  {
    date: "09/03/2025",
    mood: "Angry",
    image: Angry,
    journal:
      "Got into a disagreement at work. The day was frustrating and I couldn’t focus.",
  },
  {
    date: "11/03/2025",
    mood: "Fear",
      ...
      <div className="py-6" id="history">
        {mockData.map((log, index) => (
          <div key={index} className="flex items-center justify-between py-4 border-b border-gray-200 gap-4">
            {/* Left: Date, Image, Journal */}
            <div className="flex items-center gap-8 md:gap-16">
              <span className="text-gray-500 text-sm w-20">{log.date}</span>
              <img
                src={log.image}
                alt={log.mood}
