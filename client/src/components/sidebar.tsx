    ...
    <div>
        ...
        <aside id="default-sidebar" className="fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
                <div className="flex flex-col h-full px-3 py-4 overflow-y-auto bg-gray-50" id="elements">
                    ...
                    <div className='mb-8'>
                    <button type="button" className="text-white bg-purple-600 hover:bg-purple-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center w-full justify-center">
                        Add daily mood
                    ...
                    <ul className="space-y-2 font-medium">
                        ...
                        <div id="logout" className="space-y-2 font-medium mt-auto">
                            <button onClick={logout} className="flex items-center p-2 text-gray-900 rounded-lg hover:bg-purple-100 group">
