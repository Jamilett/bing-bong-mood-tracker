  ...
  return (
    <>
      ...
      <button
        ...
        className="inline-flex items-center p-2 mt-2 ms-3 text-sm text-purple-600 rounded-lg sm:hidden hover:bg-purple-100 focus:outline-none focus:ring-2 focus:ring-purple-200"
      >
        ...
        <div className="flex flex-col h-full px-3 py-4 overflow-y-auto">
          ...
          <div className="mb-8">
            <button
              ...
              className="text-white bg-purple-600 hover:bg-purple-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 w-full justify-center flex items-center"
            >
              Add daily mood
              <svg
          ...
          <ul className="space-y-2 font-medium">
            <li
              ...
              className="flex items-center p-2 text-gray-900 rounded-lg hover:bg-purple-100 cursor-pointer"
            >
              <svg
          ...
          <div className="mt-auto">
            <button
              ...
              className="flex items-center p-2 text-gray-900 rounded-lg hover:bg-purple-100"
            >
              <svg
                className="w-5 h-5 text-gray-500"
                fill="none"
